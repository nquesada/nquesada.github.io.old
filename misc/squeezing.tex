...
Pair number distribution: if $N=2n$ with PMF $p(N=2n) = |\braket{2n|r}|^2$ has a negative binomial distribution $\text{NB}\left(r=\tfrac{1}{2},p = 1-\tanh^2 r\right)$. This file can be found at \url{https://nquesada.github.io/misc/squeezing.pdf}
}
